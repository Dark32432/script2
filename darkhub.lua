...
local Window = Libary:MakeWindow({
    ...
    SubTitle = "by: dark ne vida",
    LoadText = "Carregando Dark Hub",
    Flags = "DarkHub_Broookhaven"
})
...
InfoTab:AddParagraph({ "Owner / Developer:", "dark, e lczinn" })
InfoTab:AddParagraph({ "Colaborações:", "Ninguém" })
InfoTab:AddParagraph({ "Você está usando:", "Dark Hub Brookhaven " })
...
Label.Text = "Bring Parts | Made by: dark"
